...
;; Time-stamp: <2007-08-22 02:20:38 guerry>
 
;; Copyright (C) 2002 2003 2004 2005 2006 Bastien Guerry

;; Author: Bastien Guerry <bzg AT altern DOT org>
;; Maintainer: Bastien Guerry <bzg AT altern DOT org>
;; Version: $Id: bhl.el,v 1.75 2007/08/22 00:21:41 bastien1 Exp $
...
;; Fontlock keywords
(defun bhl-set-font-lock-keywords ()
	 ...
	 (nombre
	  (if (equal frombuffer "*toc*")
	    ...
	    (progn (beginning-of-line)
		   ...
		   (string-to-number (bhl-match-string 1))))))
    (when (numberp nombre)
      (other-window 1)
      (goto-char nombre)
      (recenter 0)
